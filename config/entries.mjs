...
export const entries = [
  { id: 'title', html: 'title.html', kind: 'game', port: 5182, open: true, navigationDependencies: ['menu', 'battle'], assetProfiles: [] },
  ...
  { id: 'mansion', html: 'mansion.html', kind: 'game', port: 5173, navigationDependencies: ['shop', 'map', 'title', 'dice'], assetProfiles: ['mansion', 'paper-dolls'] },
  ...
  { id: 'battle', html: 'battle.html', kind: 'game', port: 5173, navigationDependencies: ['mansion', 'map', 'title', 'character-status'], assetProfiles: ['paper-dolls'] },
  ...
  { id: 'rp', html: 'rp.html', kind: 'lab', port: 5175, navigationDependencies: [], assetProfiles: ['paper-dolls'] },
