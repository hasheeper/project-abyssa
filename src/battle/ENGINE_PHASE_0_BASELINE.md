...
```sh
npx vitest run src/battle/engine.test.ts src/battle/ExpeditionBattleScreen.test.tsx
```
...
```sh
npx vitest run \
  src/battle/engine.baseline.test.ts \
  src/battle/testing/scenario.test.ts \
  src/battle/testing/invariants.test.ts
```
