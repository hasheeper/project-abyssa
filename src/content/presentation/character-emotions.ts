 ...
 * Motion references: nod 30px, jump 72px, waver 8px, light shake 12px.
 * Nods descend steadily and rise faster; all gesture amplitudes remain readable after the shared 1600px stage scales down.
...
export const CHARACTER_EMOTION_PROFILES: Record<string, CharacterEmotionProfile> = {
  abyssa: {
    ...
    cues: {
      neutral: cue("a"), smile: cue("b"), joy: cue("c", "sparkle", "nod", 23, 980),
    ...
    specials: { "star-eyes": cue("star-eyes", "sparkle", "nod", 26, 920), "cat-mouth": cue("cat-mouth", "note") },
  },
  alvitr: {
    direction: "克制老兵：稳住重心，认可才轻颔首；不跳跃、不用夸张冷汗表达警戒。",
    cues: {
      neutral: cue("a"), smile: cue("b", null, "nod", 23, 780), joy: cue("c", null, "nod", 26, 800),
      sad: cue("d"), angry: cue("e"), surprised: cue("f", "exclaim"),
      serious: cue("g"), closed: cue("h"), wry: cue("i"), flustered: cue("j", "ellipsis"),
      displeased: cue("k"), confident: cue("l", null, "nod", 23, 740),
  ...
  elora: {
    ...
    cues: {
      neutral: cue("a"), smile: cue("b", null, "nod", 26, 880), joy: cue("c", "note", "jump", 64, 760),
      sad: cue("d", "gloom"), angry: cue("e", "anger", "nod", 30, 770),
      surprised: cue("f", "exclaim", "shakeLight", 12, 480), serious: cue("g", null, "nod", 26, 780),
      closed: cue("h"), wry: cue("i", "sweatdrop"), flustered: cue("j", "blush", "waver", 8, 760),
      displeased: cue("k", "anger"), confident: cue("l", null, "nod", 26, 810),
  ...
  eustice: {
    ...
    cues: {
      neutral: cue("a"), smile: cue("b"), joy: cue("c", "sparkle", "nod", 30, 770),
      sad: cue("d", "gloom"), angry: cue("e", "anger", "nod", 41, 710),
      surprised: cue("f", "exclaim", "shakeLight", 14, 420), serious: cue("g", null, "nod", 26, 720),
      closed: cue("h"), wry: cue("i", "ellipsis"), flustered: cue("j", "blush", "shakeLight", 12, 450),
      displeased: cue("k", "anger", "nod", 26, 720), confident: cue("l", "glitter", "nod", 30, 750),
  ...
  kororo: {
    ...
    cues: {
      neutral: cue("a"), smile: cue("b"), joy: cue("c", "note", "nod", 30, 1040),
    ...
    specials: { wink: cue("wink", "sparkle", "nod", 26, 950) },
  },
  lenore: {
    direction: "寡言带刺：不悦压成低气压，坦率善意才令她轻晃；讲读时沉静可靠。",
    cues: {
      neutral: cue("a"), smile: cue("b"), joy: cue("c", null, "nod", 20, 950),
      ...
      confident: cue("l", null, "nod", 23, 850), confused: cue("m", "question"),
  ...
  marietta: {
    ...
    cues: {
      neutral: cue("a"), smile: cue("b"), joy: cue("c", null, "nod", 20, 920),
      ...
      confident: cue("l", null, "nod", 20, 860), confused: cue("m", "question"), panicked: cue("n", "ellipsis"),
    },
  },
  norma: {
    ...
    cues: {
      ...
      wry: cue("i", "sparkle", "nod", 26, 730), flustered: cue("j", "sweatdrop", "shakeLight", 12, 440),
      displeased: cue("k", "sweatdrop"), confident: cue("l", "idea", "nod", 30, 730),
  ...
  tibby: {
    ...
    cues: {
      neutral: cue("a"), smile: cue("b", null, "nod", 30, 750), joy: cue("c", "note", "jump", 84, 700),
      sad: cue("d", "gloom", "waver", 10, 700), angry: cue("e", "anger", "nod", 38, 710),
      surprised: cue("f", "exclaim", "jump", 52, 620), serious: cue("g"), closed: cue("h"),
      wry: cue("i", "sparkle", "nod", 30, 760), flustered: cue("j", "sweatdrop", "waver", 10, 620),
      displeased: cue("k", "gloom"), confident: cue("l", "glitter", "nod", 35, 730),
      confused: cue("m", "question"), panicked: cue("n", "sweat", "shakeLight", 20, 530),
    },
    specials: { "smiling-eyes": cue("smiling-eyes", "glitter", "nod", 30, 800) },
  },
  vivienne: {
    direction: "贵妇与策士：得意华丽但不跳跃，恼怒保持端稳；失去掌控时才轻微失衡。",
    cues: {
      neutral: cue("a"), smile: cue("b"), joy: cue("c", "glitter", "nod", 23, 940),
      sad: cue("d", "gloom"), angry: cue("e"), surprised: cue("f", "exclaim"),
      serious: cue("g"), closed: cue("h"), wry: cue("i", "sparkle", "nod", 23, 880),
