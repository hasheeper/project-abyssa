...
export interface RibbonFrameArtProps {
  className?: string;
...
export function RibbonFrameArt({
  className,
  watermark,
  sideDiamonds = true,
  frameOnly = false,
  ...
  return (
    <svg
      className={cx("abyssa-ribbon-button__art", className)}
      viewBox="0 0 820 68"
    ...
    >
      ...
      {!frameOnly && <path d="M35 11 H788 L769 38 L788 65 H35 L56 38 Z" fill="#111616" opacity=".72" />}
      {!frameOnly && <path d="M34 7 H786 L765 34 L786 61 H34 L55 34 Z" fill="var(--abyssa-ribbon-fill)" />}
      {!frameOnly && watermarkOptions && <rect
        x="30"
        y="4"
        width="760"
        height="60"
        ...
        clipPath={`url(#${clipId})`}
      />}
      <path className="abyssa-ribbon-button__frame-dark" d="M34 7 H786 L765 34 L786 61 H34 L55 34 Z" fill="none" strokeWidth="7" />
      <path d="M34 7 H786 L765 34 L786 61 H34 L55 34 Z" fill="none" stroke="var(--abyssa-frame-light)" strokeWidth="4" />
      <path className="abyssa-ribbon-button__frame-dark" d="M34 7 H786 L765 34 L786 61 H34 L55 34 Z" fill="none" strokeWidth="2" />
      {sideDiamonds && (
        <g>
