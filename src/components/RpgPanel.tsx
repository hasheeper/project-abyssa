  ...
  function RpgPanel(
    ...
    return (
      <button
        ...
        {...props}
      >
        <svg viewBox="0 0 180 180" preserveAspectRatio={preserveAspectRatio} aria-hidden="true">
          ...
          <rect className="abyssa-panel-tile__shadow" x="8" y="9.5" width="164" height="164" fill="#0d1212" opacity=".52" />
          ...
          <rect className="abyssa-panel-tile__frame" data-frame-layer="outer" x="8" y="7" width="164" height="164" fill="none" stroke="var(--abyssa-frame-dark)" strokeWidth="7" />
          <rect className="abyssa-panel-tile__frame" data-frame-layer="middle" x="8" y="7" width="164" height="164" fill="none" stroke="var(--abyssa-tile-middle)" strokeWidth="4" />
          <rect className="abyssa-panel-tile__frame" data-frame-layer="inner" x="8" y="7" width="164" height="164" fill="none" stroke="var(--abyssa-frame-deep)" strokeWidth="2" />
          <rect className="abyssa-panel-tile__ornament" x="15" y="14" width="150" height="150" fill="none" stroke="var(--abyssa-tile-ornament)" strokeWidth="1.25" opacity=".94" />
          <rect className="abyssa-panel-tile__ornament" x="18" y="17" width="144" height="144" fill="none" stroke="var(--abyssa-tile-ornament)" strokeWidth=".7" opacity=".55" />
          <g className="abyssa-panel-tile__ornament" fill="none" stroke="var(--abyssa-tile-ornament)" strokeLinecap="square">
          ...
          <g className="abyssa-panel-tile__ornament" fill="none" stroke="var(--abyssa-tile-ornament)" strokeWidth="1" opacity=".9">
            <path d="M25 16 H45 M16 25 V45 M135 16 H155 M164 25 V45" />
            <path d="M25 164 H45 M16 135 V155 M135 164 H155 M164 135 V155" />
          </g>
          <g className="abyssa-panel-tile__ornament" fill="var(--abyssa-tile-ornament)">
