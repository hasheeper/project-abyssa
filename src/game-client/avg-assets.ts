...
import shopBackground from "../assets/backgrounds/shop-bg3.jpg";
import type { AvgStory } from "../shared/domain/avg/story";

const backgrounds: Record<string, string> = { "mansion.first-morning": morningBackground, "mansion.night": nightBackground, "shop.counter": shopBackground };
const presets: Record<string, { className: string; locationLabel: string }> = {
  "shop-counter": { className: "rp-app first-morning", locationLabel: "SHOP" },
...
export function avgPresentation(story: Pick<AvgStory, "id" | "presentation">) {
