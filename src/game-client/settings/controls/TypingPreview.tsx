 ...
 * 恢复的相位是不确定的。
 */
export function TypingPreview({ step, dur, reducedMotion, active = true }: TypingPreviewProps) {
  ...
  }, [token, totalMs, reducedMotion, active]);
  ...
  return (
    <div className="settings-preview" data-preview-waiting={!active || undefined}>
      ...
      <div
        ...
        data-kind="say"
        data-current={reducedMotion || !active ? undefined : true}
        style={
          {
