...
import { assertExpeditionInvariants as unbound_assertExpeditionInvariants } from "../../../../game-core/battle/domain/invariants";
import {
  getEnemyFrenzyWarningStatus as unbound_getEnemyFrenzyWarningStatus,
  isEnemyFrenzied as unbound_isEnemyFrenzied
} from "../../../../game-core/battle/rules/frenzy-status";
const assertExpeditionInvariants = unbound_assertExpeditionInvariants.bind(null, LEGACY_CONTEXT);
const getEnemyFrenzyWarningStatus = unbound_getEnemyFrenzyWarningStatus.bind(null, LEGACY_CONTEXT);
 ...
 */
export function runDeterministicExpedition(
  seed: number,
  maxSteps = 500,
  observe?: (command: string, state: ExpeditionState) => void
): BaselineRun {
