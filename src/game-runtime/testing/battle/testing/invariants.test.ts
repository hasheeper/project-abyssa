...
import { endTurn, mulberry32, nextRound, type ExpeditionState } from "../../../legacy-battle";
import { actScenario } from "./scenario";
import {
  assertExpeditionInvariants as unbound_assertExpeditionInvariants,
  collectExpeditionInvariantViolations as unbound_collectExpeditionInvariantViolations
} from "../../../../game-core/battle/domain/invariants";
const assertExpeditionInvariants = unbound_assertExpeditionInvariants.bind(null, LEGACY_CONTEXT);
const collectExpeditionInvariantViolations = unbound_collectExpeditionInvariantViolations.bind(null, LEGACY_CONTEXT);
