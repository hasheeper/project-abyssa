...
import { resolveEnemyIntentTransition as unbound_resolveEnemyIntentTransition } from "../../../../game-core/battle/rules/enemy-intents";
import { prepareEnemyTurnTransition as unbound_prepareEnemyTurnTransition } from "../../../../game-core/battle/rules/turns";
const resolveEnemyIntentTransition = unbound_resolveEnemyIntentTransition.bind(null, LEGACY_CONTEXT);
