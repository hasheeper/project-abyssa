...
import type { EnemyState, ExpeditionState } from "../../../../game-core/battle/domain/state";
...
import { settleEnemyTurnTransition as unbound_settleEnemyTurnTransition } from "../../../../game-core/battle/rules/settlement";
import { isEnemyFrenzied as unbound_isEnemyFrenzied } from "../../../../game-core/battle/rules/frenzy-status";
import {
  activateScheduledFrenzyForNextRoundTransition as unbound_activateScheduledFrenzyForNextRoundTransition,
  applyFrenzyRecoilTransition as unbound_applyFrenzyRecoilTransition,
  completeNextRoundAfterFrenzyTransition as unbound_completeNextRoundAfterFrenzyTransition,
  prepareEnemyTurnTransition as unbound_prepareEnemyTurnTransition
} from "../../../../game-core/battle/rules/turns";
const settleEnemyTurnTransition = unbound_settleEnemyTurnTransition.bind(null, LEGACY_CONTEXT);
const isEnemyFrenzied = unbound_isEnemyFrenzied.bind(null, LEGACY_CONTEXT);
const activateScheduledFrenzyForNextRoundTransition = unbound_activateScheduledFrenzyForNextRoundTransition.bind(null, LEGACY_CONTEXT);
const applyFrenzyRecoilTransition = unbound_applyFrenzyRecoilTransition.bind(null, LEGACY_CONTEXT);
const completeNextRoundAfterFrenzyTransition = unbound_completeNextRoundAfterFrenzyTransition.bind(null, LEGACY_CONTEXT);
