...
import type {
  ...
  AtomicEffectBase,
  EffectModifier
} from "../../../../game-core/battle/domain/effects";
import type {
  BattleLoadoutSnapshot,
  ExpeditionState,
  ItemInstance
} from "../../../../game-core/battle/domain/state";
import {
...
import { dispatchBattleCommand as unbound_dispatchBattleCommand } from "../../../../game-core/battle/rules/dispatcher";
import { createExpeditionStateFromInput as unbound_createExpeditionStateFromInput } from "../../../../game-core/battle/rules/expedition";
import { createBattleLoadoutSettlement } from "../../../../game-core/battle/rules/loadout";
import { mulberry32 } from "../../../../game-core/battle/persistence/rng";
import { resolveAtomicEffects as unbound_resolveAtomicEffects, resolveEffectsCommand as unbound_resolveEffectsCommand } from "../../../../game-core/battle/rules/resolver";
const dispatchBattleCommand = unbound_dispatchBattleCommand.bind(null, LEGACY_CONTEXT);
const createExpeditionStateFromInput = unbound_createExpeditionStateFromInput.bind(null, LEGACY_CONTEXT);
const resolveAtomicEffects = unbound_resolveAtomicEffects.bind(null, LEGACY_CONTEXT);
const resolveEffectsCommand = unbound_resolveEffectsCommand.bind(null, LEGACY_CONTEXT);
